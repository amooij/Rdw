...
use Nettob\Component\Rdw\Model\Carrosserie;

/**
 * Carrosserie Repository.
 *
 * @author Nico Borghuis <nico@nicoborghuis.nl>
 */
class CarrosserieRepository extends AbstractRepository
{
    public function __construct()
    {
        $this->apiUrl = 'https://opendata.rdw.nl/resource/3huj-srit.json';
        parent::__construct();
    }
    ...
    public function find($query)
    {
        ...
        foreach ($results as $result) {
            $kenteken = new Carrosserie($result);
            if ($countResults > 1) {
                $kentekens[] = $kenteken;
            } else {
                return $kenteken;
