...
use Nettob\Component\Rdw\Model\Voertuigklasse;

/**
 * Voertuigklasse Repository.
 *
 * @author Nico Borghuis <nico@nicoborghuis.nl>
 */
class VoertuigklasseRepository extends AbstractRepository
{
    ...
    public function find($query)
    {
        ...
        foreach ($results as $result) {
            $kenteken = new Voertuigklasse($result);
            if ($countResults > 1) {
                $kentekens[] = $kenteken;
            } else {
                return $kenteken;
