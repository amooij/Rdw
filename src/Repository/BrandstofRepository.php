...
use Nettob\Component\Rdw\Model\Brandstof;

/**
 * Brandstof Repository.
 *
 * @author Nico Borghuis <nico@nicoborghuis.nl>
 */
class BrandstofRepository extends AbstractRepository
{
    public function __construct()
    {
        $this->apiUrl = 'https://opendata.rdw.nl/resource/8ys7-d773.json';
        parent::__construct();
    }
